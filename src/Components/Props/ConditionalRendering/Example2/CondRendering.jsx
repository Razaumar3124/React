...
const CondRendering = () => {
    let api = [
        {
          ...
          },
          {
            ...
            "description": "The Red Nail Polish offers a rich and glossy red hue for vibrant and polished nails. With a quick-drying formula, it provides a salon-quality finish at home nice.",
            "category": "beauty",
            "price": 8.99,
  ...
  return (
    <div>
        <Cart data={{login,setLogin,isCartTrue,setIsCartTrue,api}}/>
    </div>
  )
}
